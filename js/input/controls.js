...
// Movement direction is relative to where the camera is currently facing
// (yaw only - pitch shouldn't speed up/slow down walking).
...
export function updatePlayer(dt) {
  ...
  if (moving && (dx * dx + dz * dz) > 0.000001) {
    ...
    character.rotation.y = lerpAngle(character.rotation.y, desiredFacing, 0.22);
  }

  updateCharacterAnim(dt, moving);
}
